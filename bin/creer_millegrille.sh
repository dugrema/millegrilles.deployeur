...
creer_repertoires() {
  ...
  sudo -u $MILLEGRILLES_USER_DEPLOYEUR mkdir -p \
    $MILLEGRILLES_CONSIGNATION_TORRENTS/downloads \
    $MILLEGRILLES_CONSIGNATION_TORRENTS/seeding \
    $MILLEGRILLES_CONSIGNATION_TORRENTS/torrentfiles
  ...
  sudo chmod 2775 $REP_NGINX $REP_CONSIGNATION_LOCAL $$MILLEGRILLES_CONSIGNATION_TORRENTS
