...
sudo mkdir -p $REP_MILLEGRILLE/dist/secure/maitredescles
sudo mkdir -p $REP_MILLEGRILLE/dist/secure/pki
sudo chown $CURRENT_USER:millegrilles $REP_MILLEGRILLE/dist
